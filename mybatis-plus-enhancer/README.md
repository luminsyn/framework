...
### Splicer反注入自定义参数
使用`io.github.bootystar.mybatisplus.core.helper.SqlHelper`作为入参
...
3. <font style="background-color:rgba(255, 255, 255, 0);">若实体类实现了`io.github.bootystar.mybatisplus.core.EnhanceEntity`接口,根据实现方法添加额外字段</font>
