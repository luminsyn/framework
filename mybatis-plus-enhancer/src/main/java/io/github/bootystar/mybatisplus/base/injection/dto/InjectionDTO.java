...
import io.github.bootystar.mybatisplus.base.injection.InjectionException;
import io.github.bootystar.mybatisplus.base.injection.enums.Connector;
...
public class InjectionDTO extends RecursionDTO {
     ...
     */
    @Getter
    public static final class SafetyInjector<T> extends RecursionDTO {
        /**
         * 实体类
         */
        ...
        private SafetyInjector(InjectionDTO injector, Class<T> entityClass) {
            this.entityClass = entityClass;
            antiInjection(injector);
        }


        private void antiInjection(InjectionDTO injector) {
            if (entityClass == null) {
